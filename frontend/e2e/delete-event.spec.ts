 ...
 * "Delete permanently" button stays disabled until the exact event name is re-typed. Then confirm
 * and assert the event row disappears from the list (the delete really took effect server-side).
 *
