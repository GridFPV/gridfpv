...
describe('TunePage — Capture: one button, one pass, BOTH levels (#355, #465)', () => {
  ...
  it('reports a capture that did not land, rather than showing it as a success', async () => {
    ...
    expect(screen.getByTestId('capture-detail-0')).toHaveTextContent(
      /still reporting Enter at 90 and Exit at 80.*Nothing was captured and nothing was recorded/s
    );
